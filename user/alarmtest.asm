...
void periodic()
{
  ...
  2e:	788080e7          	jalr	1928(ra) # 7b2 <sigreturn>
}
  32:	60a2                	ld	ra,8(sp)
  34:	6402                	ld	s0,0(sp)
...
void slow_handler()
{
  ...
  90:	726080e7          	jalr	1830(ra) # 7b2 <sigreturn>
}
  94:	60e2                	ld	ra,24(sp)
  96:	6442                	ld	s0,16(sp)
  98:	64a2                	ld	s1,8(sp)
...
void dummy_handler()
{
  ...
  d0:	6e6080e7          	jalr	1766(ra) # 7b2 <sigreturn>
}
  d4:	60a2                	ld	ra,8(sp)
  d6:	6402                	ld	s0,0(sp)
