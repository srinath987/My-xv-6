...
int main(int argc, char **argv)
{
  ...
  36:	85e50513          	addi	a0,a0,-1954 # 890 <malloc+0xfa>
  ...
  98:	80c50513          	addi	a0,a0,-2036 # 8a0 <malloc+0x10a>
...
malloc(uint nbytes)
{
 ...
 870:	b50080e7          	jalr	-1200(ra) # 3bc <sbrk>
  if(p == (char*)-1)
